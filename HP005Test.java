...
public class HP005Test {
  ...
  public void hP005() {
    ...
    driver.findElement(By.cssSelector("#menu-item-289 .aux-menu-label")).click();
    js.executeScript("window.scrollTo(0,383)");
    driver.findElement(By.cssSelector(".eicon-close:nth-child(1)")).click();
    driver.findElement(By.cssSelector(".post-957 > .post")).click();
    driver.findElement(By.linkText("ECG")).click();
    js.executeScript("window.scrollTo(0,433)");
